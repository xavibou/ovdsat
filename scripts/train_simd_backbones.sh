...
for backbone in georsclip-14 dinov2 clip-14 clip-32 georsclip-32 remoteclip-14 remoteclip-32
do
    echo "Training ${backbone}"
    python train.py \
        --root_dir /mnt/ddisk/boux/code/data/simd/training \
        --save_dir "run/train/simd_experiments/train/learned_prototype_${backbone}" \
